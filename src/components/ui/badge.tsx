  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        verified: "border-transparent bg-success/10 text-success",
        unverified: "border-transparent bg-warning/10 text-warning",
        online: "border-transparent bg-primary-light text-primary",
