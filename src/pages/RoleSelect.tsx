...
const RoleSelect = () => {
  ...
  const handleSelectRole = (role: 'requester' | 'provider') => {
    switchRole(role);
    if (role === 'provider') {
      navigate('/onboarding');
    } else {
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8">
        ...
        <div className="space-y-4">
          ...
          >
            <Card
              variant="interactive"
              className="p-6 border-2 border-transparent hover:border-primary transition-all"
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mt-1">
                    Post jobs and hire verified service providers
                  </p>
                </div>
          ...
          >
            <Card
              variant="interactive"
              className="p-6 border-2 border-transparent hover:border-secondary transition-all"
              onClick={() => handleSelectRole('provider')}
            >
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-2xl bg-secondary-light flex items-center justify-center">
